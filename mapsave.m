function phase = mapsave(rho, dimension, save_path, file_prefix)
    % 检查输入维度是否有效
    ...
    % 保存振幅图
    amplitude_filename = fullfile(save_path, [file_prefix '_amplitude.png']);
    ...
    % 保存相位图
    phase_filename = fullfile(save_path, [file_prefix '_phase.png']);
